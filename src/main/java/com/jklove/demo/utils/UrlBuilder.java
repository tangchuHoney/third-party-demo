...
import com.jklove.demo.consts.ApiUrl;
...
public class UrlBuilder {
    ...
    private static final String WECHAT_MINA_ACCESS_TOKEN_PATTERN= "{0}?appid={1}&secret={2}&js_code={3}&grant_type=authorization_code";
     ...
     * @param jsCode         微信小程序 wx.login后得到的 jsCode，
     * @return full url
     */
    public static String getWeChatMinaAccessTokenUrl(String clientId, String clientSecret, String jsCode) {
        return MessageFormat.format(WECHAT_MINA_ACCESS_TOKEN_PATTERN, ApiUrl.WECHAT_MINA.accessToken(), clientId, clientSecret, jsCode);
    }
    /**
     * 获取微信 授权地址
     *
